...
// protected:
//     void SetUp() override {
//         auto arithRule = [](Sequence<long long>* prev) -> long long {
//             size_t idx = prev->GetCount();
//             return idx + 1;
//         };
//         ArraySequence<long long> empty;
//         arithSeq = new LazySequence<long long>(arithRule, &empty, 0);
        
//         auto constRule = [](Sequence<long long>* prev) -> long long {
//             return 42;
//         };
//         constSeq = new LazySequence<long long>(constRule, &empty, 0);
...
//     std::string before = "sequence not materialized";
//     long long got0 = arithSeq->Get(0);
//     EXPECT_EQ(got0, 1) << "Get(0): before=" << before << ", expected 1, got " << got0;
...
// TEST_F(LazySequenceTest, GetMaterializedCount) {
//     size_t before = arithSeq->GetMaterializedCount();
//     arithSeq->Get(20);
//     size_t after = arithSeq->GetMaterializedCount();
//     EXPECT_GT(after, before) << "MaterializedCount: before=" << before << ", after=" << after;
// }
...
//     EXPECT_TRUE(arithSeq->IsInfinite()) << "Arithmetic sequence should be infinite";
